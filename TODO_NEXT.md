...
- Release coordinata precedente verificata: 2.17.5 build 71.
- Versione in preparazione: 2.18.0 build 72, con Riferimenti separati dalle
  attività e completamento visivamente stabile.
