...
- Release coordinata precedente verificata: 2.18.3 build 75.
- Versione in preparazione: 2.18.4 build 76, con `Esc` che chiude l'editor Web,
  prossima data delle ricorrenze negli avvisi e chiusura immediata degli avvisi.
