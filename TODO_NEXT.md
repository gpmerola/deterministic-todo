...
- Release coordinata precedente verificata: 2.18.0 build 72.
- Versione in preparazione: 2.18.1 build 73, con Progetti nuovamente unico
  sistema organizzativo, Invio fisico nell'editor Web e sync periodico ridotto.
