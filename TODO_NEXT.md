...
- Release coordinata precedente verificata: 2.17.4 build 70.
- Versione in preparazione: 2.17.5 build 71, con Invio coerente tra creazione e
  modifica in tutte le sezioni e protezione dai doppi salvataggi.
