...
- Release coordinata corrente verificata: 2.18.4 build 76, con `Esc` che chiude
  l'editor Web, prossima data delle ricorrenze negli avvisi e chiusura immediata
  degli avvisi.
