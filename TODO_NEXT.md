...
- Release coordinata precedente verificata: 2.17.3 build 69.
- Versione in preparazione: 2.17.4 build 70, con editor inline nel pannello
  desktop e documentazione riallineata al comportamento corrente.
