...
echo ""
echo "Pubblica aggiornamento macOS + Android"
echo ""
...
echo ""
echo "Pubblicato. GitHub sta creando entrambe le applicazioni."
echo "Controlla: https://github.com/gpmerola/deterministic-todo/actions"
echo "Quando le build sono verdi usa:"
echo "  SCARICA_APP_MAC.command"
echo "  SCARICA_APK_ANDROID.command"
echo ""
read "?Premi Invio per chiudere..."
