...
- Versione sorgente in preparazione: **2.18.4 build 76**.
- Ultima release pubblica verificata: **2.18.3 build 75** (commit `410f78a`).
- Web, release Android pubblica, Google Play interno e manifest di parità sono
  verificati sul commit `410f78a`.
- Il test interno Google Play è attivo; la 2.18.3 build 75 è disponibile alla
