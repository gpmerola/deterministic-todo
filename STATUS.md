...
- Versione in preparazione: **2.16.10 build 54**.
- Ultima release pubblica verificata: **2.16.9 build 53**.
- Il test interno Google Play è attivo; la 2.16.9 build 53 è disponibile alla
